...
import { Dropdown, Button, Icon, Grid, Card, Header, Dimmer, Loader, Segment, Image} from 'semantic-ui-react'


class App extends Component {
    constructor(props) {
        super(props);
        document.title = "FOREX FE";
        this.state = {
            USD_Rates: '10.0000',
    ...
    render() {
        ...
        const { USD_Rates, AddMore, AllData, LoadingPost } = this.state;
        return (
            <Grid centered columns={3} verticalAlign="middle" className="height-full">
                <Grid.Column>
                        ...
                        <Card>
                            ...
                            <Card.Content extra>
                                <List data={this.state} RemoveCurrency={(i) => this.RemoveCurrency(i)} type="option">
                                    <Loading type="Post" LoadingPost={LoadingPost}/>
                                    <Card>
                                        {!AddMore ?
                                            ...
                                            <div>
                                                ...
                                                <Button primary type="submit" onClick={() => this.AddCurrency()} className="btn-submit">
                                                    Submit
                                                </Button>
                                            </div>
                                        }
